 ...
 */
function WorkOrderKanbanDashboardItem({
  context
}: {
  ...
  const pluginName: string = 'WorkOrderKanban';
...
//  component
export function renderWorkOrderKanbanDashboardItem(
  context: InvenTreePluginContext
) {
  checkPluginVersion(context);
  return <WorkOrderKanbanDashboardItem context={context} />;
}
